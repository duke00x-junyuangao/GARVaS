...
#' model to each possible parent generated by \code{GARVaS::init()} based on
#' fitness rank with AIC as the default fitness function.
#'
...
#' 2 parent chromosomes from selected parent matrix produced by
#' \code{GARVaS::selection()} to perform the process of crossover and mutation
#' which is based on the \code{GARVaS::crossover()}
#'
